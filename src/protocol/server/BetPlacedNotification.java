...
public class BetPlacedNotification extends ServerNotification
    implements Serializable {
    
    private PlayerProtocol player;
    private PlayerProtocol[] players;

    public BetPlacedNotification(PlayerProtocol[] players, PlayerProtocol player) {
        super();
        this.player = player;
